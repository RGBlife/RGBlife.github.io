...
export const TechGrid = () => {
  const techs = [
    ...
    {
      icon: "src/assets/Typescript_logo_2020.svg",
      name: "TypeScript",
      description:
    ...
    {
      icon: "src/assets/React-icon.svg",
      name: "React",
      description:
