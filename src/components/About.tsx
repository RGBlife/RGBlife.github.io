  ...
  return (
    ...
    >
      ...
      <p className="max-w-screen-lg fade-effect">
        ...
        pandemic, and culminated in my current pursuit of software development.
      </p>
      ...
      <p className="max-w-screen-lg fade-effect">
        ...
        and testing for the UK's largest ergonomic chair supplier. Transitioning
        to a Junior CRM Developer role, my fascination with coding truly
        ignited, driving me to further explore the intricacies of software
        development.
      </p>
